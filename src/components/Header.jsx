        ...
        <header className="header">
            <div className="header-container">
                ...
                <div className="header-right">
                    <Navigation isMobile={false} isOpen={isMobileMenuOpen} setIsMobileMenuOpen={setIsMobileMenuOpen}/>
                    <CTAButton 
            ...
            <Navigation isMobile={true} isOpen={isMobileMenuOpen} setIsMobileMenuOpen={setIsMobileMenuOpen}/>
        </header>
    );
};
